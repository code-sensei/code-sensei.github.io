-- =============================================================================
-- AEO Blog Post - SQL Insert for Supabase
-- =============================================================================
...
-- Clear existing post with this slug (if re-running)
DELETE FROM blog_posts WHERE slug = 'beyond-seo-building-for-ai-search-engines';

-- Insert the new AEO blog post
INSERT INTO blog_posts (
  ...
  'beyond-seo-building-for-ai-search-engines',
...
*Have questions about implementing AEO on your site? Reach out on [Twitter](https://twitter.com/iam_ehnigma) or [LinkedIn](https://linkedin.com/in/btsowa).*',
  '/blog/aeo-ai-search-optimization.jpg',
  'Babangida Tsowa',
  '/profile-image.png',
  ...
  NOW(),
  'SEO/AEO',
  ARRAY['AEO', 'SEO', 'AI', 'Structured Data', 'Schema.org', 'ChatGPT', 'Perplexity', 'Edge Functions', 'Web Development', 'Search Optimization'],
  18,
  false,
  true
);
...
-- Verify insertion
SELECT id, title, slug, category, reading_time, featured, published
FROM blog_posts
WHERE slug = 'beyond-seo-building-for-ai-search-engines';
