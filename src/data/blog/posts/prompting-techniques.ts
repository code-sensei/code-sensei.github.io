...
export const promptingTechniques: BlogPost = {
  id: "3",
  title: "My Guide To AI Prompting Techniques",
  slug: "my-guide-to-mastering-ai-prompting-techniques",
  excerpt:
  ...
  content: `# My Guide to Prompt Engineering Techniques
...
Found this guide helpful? Save it for your next project or share it with a developer who needs it.`,
  ...
  author: {
    ...
    bio: "Fullstack Product Engineer, AI Engineer & Technology Consultant",
  },
  publishedAt: "2025-02-11T10:00:00Z",
  category: "AI Engineering",
  tags: ["AI", "Prompting", "LLM", "Best Practices", "Machine Learning"],
  readingTime: 10,
  featured: false,
  published: true,
};
