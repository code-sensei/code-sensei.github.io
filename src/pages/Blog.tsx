        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-black/70 dark:text-white/70 font-mono mb-8 leading-relaxed max-w-2xl">
              Practical insights from building AI products, leading engineering
              teams, and navigating the future of technology.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mt-6 text-sm font-mono text-black/60 dark:text-white/60">
              ...
              <span>•</span>
              <span>
                {allPosts.reduce((acc, p) => acc + p.readingTime, 0)} min total
                reading
              </span>
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs font-mono text-black/60 dark:text-white/60">
                        {format(new Date(heroPost.publishedAt), "MMM dd, yyyy")}
                      </div>
                    </div>
                  </div>
        ...
        {allPosts.length > 0 && !hasActiveFilters && (
          ...
          >
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { value: allPosts.length, label: "Articles", color: "#FFE156" },
                {
