...
const Cheatsheets: React.FC = () => {
    ...
    const [selectedType, setSelectedType] = useState<"all" | "image" | "page">("all");
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                >
                    ...
                    <div className={`space-y-4 ${!showFilters && "hidden lg:block"}`}>
                        ...
                        <div className="flex flex-wrap gap-2 justify-center">
                            {[
                                { value: "all", label: "All Types", icon: <Layers className="w-3.5 h-3.5" /> },
                                { value: "image", label: "Images", icon: <ImageIcon className="w-3.5 h-3.5" /> },
                                { value: "page", label: "Pages", icon: <FileText className="w-3.5 h-3.5" /> },
                            ].map((type) => (
                                <button
                                    key={type.value}
                                    onClick={() => setSelectedType(type.value as "all" | "image" | "page")}
                        ...
                        <div className="flex items-center justify-center gap-3 flex-wrap p-4 rounded-2xl bg-primary/5 border border-primary/20 max-w-3xl mx-auto animate-slideDown">
                            ...
                            {selectedType !== "all" && (
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-background border border-border">
                                    ...
                                    <span className="text-xs font-medium capitalize">{selectedType}</span>
                                    <button
                ...
                {filteredCheatsheets.length > 0 ? (
                    ...
                    <div className="text-center py-20 animate-fadeIn">
                        ...
                        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                            We couldn't find any cheatsheets matching your search. Try adjusting
