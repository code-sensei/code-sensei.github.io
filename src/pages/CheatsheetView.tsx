...
const CheatsheetView: React.FC = () => {
        ...
        return (
            <div className="min-h-screen bg-[#FFFEF0] dark:bg-[#1a1a2e] pt-20 flex items-center justify-center">
                <div className="text-center animate-fadeIn">
                    ...
                    <h1 className="text-2xl font-black mb-2 uppercase tracking-tight">Loading...</h1>
        ...
        return (
            <div className="min-h-screen bg-[#FFFEF0] dark:bg-[#1a1a2e] pt-20 flex items-center justify-center">
                <div className="text-center animate-fadeIn p-8">
                    ...
                    <h1 className="text-4xl font-black mb-4 uppercase tracking-tight">Not Found</h1>
    ...
    return (
        <div className={`min-h-screen ${isPageType ? 'bg-[#FFFEF0] dark:bg-[#1a1a2e]' : 'bg-background'} ${isFullscreen ? '' : 'pt-20'}`}>
            <div className={`${isFullscreen ? 'h-screen flex flex-col' : 'max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12'}`}>
                {/* Back Button & Actions - Neobrutalism style for page type */}
                <div className={`${isFullscreen ? 'p-4 bg-background/95 backdrop-blur-md border-b-4 border-black dark:border-white' : 'mb-8'} animate-fadeIn flex items-center justify-between`}>
                    <button
                        onClick={() => navigate("/cheatsheets")}
                ...
                {(!isFullscreen || sheet.type === "page") && (
                    <header className={`${isFullscreen ? 'px-4 pb-4' : 'mb-10'} animate-fadeIn`}>
                        {/* Type and Category Badges - Neobrutalism */}
                        <div className="flex flex-wrap items-center gap-3 mb-6">
                            <div className={`inline-flex items-center gap-2 ${isPageType ? 'px-4 py-2 bg-[#B8E986] border-3 border-black dark:border-white text-black font-bold uppercase text-xs tracking-wider shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' : 'px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-sm font-medium text-primary'}`}>
                                {sheet.type === "image" ? (
                            ...
                            <div className={`${isPageType ? 'px-4 py-2 bg-[#DDA0DD] border-3 border-black dark:border-white text-black font-bold uppercase text-xs tracking-wider shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' : 'px-3 py-1.5 rounded-full bg-muted text-sm font-medium'}`}>
                                {sheet.category}
                            </div>
                        </div>

                        {/* Title - Neobrutalism */}
                        <h1 className={`mb-6 leading-tight ${isPageType ? 'text-4xl sm:text-5xl md:text-6xl font-black uppercase tracking-tight text-black dark:text-white' : 'text-3xl sm:text-4xl md:text-5xl font-bold'}`}>
                            {sheet.title}
                        </h1>

                        {/* Description - Neobrutalism */}
                        <p className={`mb-8 max-w-3xl ${isPageType ? 'text-lg md:text-xl font-mono text-black/70 dark:text-white/70 leading-relaxed' : 'text-lg md:text-xl text-muted-foreground'}`}>
                            {sheet.description}
                        </p>

                        {/* Meta Information - Neobrutalism */}
                        <div className={`flex flex-wrap items-center gap-4 mb-6 ${isPageType ? 'font-mono text-sm' : 'text-sm text-muted-foreground'}`}>
                            <div className={`inline-flex items-center gap-2 ${isPageType ? 'px-3 py-1.5 bg-white dark:bg-[#2d2d44] border-2 border-black dark:border-white text-black dark:text-white' : ''}`}>
                ...
                {/* Content */}
                <div className={`${isFullscreen ? 'flex-1 overflow-auto' : ''} animate-fadeIn`}>
                    {sheet.type === "image" && sheet.imageUrl ? (
                        /* Image Cheatsheet View */
                        <div className={`${isFullscreen ? 'h-full flex items-center justify-center p-4 bg-muted/30' : 'rounded-2xl overflow-hidden border border-border shadow-lg'}`}>
                            <div 
                        ...
                        <div className="neobrutalism-content">
                            <ReactMarkdown
                                ...
                                components={{
                                    h1: ({ children }) => (
                                        <h1 className="text-3xl md:text-4xl font-black uppercase tracking-tight mb-8 mt-16 text-black dark:text-white pb-4 border-b-4 border-black dark:border-white">
                                            {children}
                                        </h1>
                                    ),
                                    h2: ({ children }) => (
                                        <h2 className="text-2xl md:text-3xl font-black uppercase tracking-tight mb-6 mt-12 text-black dark:text-white inline-block bg-[#FFE156] px-4 py-2 border-3 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.3)]">
                                            {children}
                                        </h2>
                                    ),
                                    h3: ({ children }) => (
                                        <h3 className="text-xl md:text-2xl font-black uppercase tracking-tight mb-4 mt-10 text-black dark:text-white inline-block bg-[#A0E7E5] px-3 py-1.5 border-2 border-black dark:border-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] dark:shadow-[3px_3px_0px_0px_rgba(255,255,255,0.3)]">
                                            {children}
                                        </h3>
                                    ),
                                    h4: ({ children }) => (
                                        <h4 className="text-lg md:text-xl font-black uppercase tracking-tight mb-3 mt-8 text-black dark:text-white inline-block bg-[#DDA0DD] px-3 py-1 border-2 border-black dark:border-white shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] dark:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.3)]">
                                            {children}
                                        </h4>
                                    ),
                                    p: ({ children }) => (
                                        <p className="mb-5 leading-relaxed text-black/80 dark:text-white/80 text-base md:text-lg font-mono">
                                            {children}
                                        </p>
                                    ),
                                    ul: ({ children }) => (
                                        <ul className="mb-6 space-y-3 text-black/80 dark:text-white/80 font-mono pl-6">
                                            {children}
                                        </ul>
                                    ),
                                    ol: ({ children }) => (
                                        <ol className="mb-6 space-y-3 text-black/80 dark:text-white/80 font-mono pl-6 list-decimal">
                                            {children}
                                        </ol>
                                    ),
                                    li: ({ children }) => (
                                        <li className="leading-relaxed pl-2 border-l-4 border-[#FFE156]">{children}</li>
                                    ),
                                    blockquote: ({ children }) => (
                                        <blockquote className="my-8 p-6 bg-[#B8E986] border-4 border-black dark:border-white text-black font-bold shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.3)]">
                                            {children}
                                        </blockquote>
                                    ),
                                    code: ({
                                        ...
                                        if (inline) {
                                            return (
                                                <code
                                                    className="px-2 py-1 bg-[#FFE156] border-2 border-black dark:border-white text-black font-mono font-bold text-sm"
                                                    {...props}
                                                >
                                                    {children}
                                                </code>
                                    ...
                                    pre: ({ children }) => (
                                        <pre className="my-6 bg-[#1a1a2e] border-4 border-black dark:border-white overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.3)]">
                                            {children}
                                        </pre>
                                    ),
                                    a: ({ children, href }) => (
                                        <a
                                            ...
                                            className="text-black dark:text-white font-bold underline decoration-4 decoration-[#FF6B6B] underline-offset-4 hover:bg-[#FF6B6B] hover:text-black transition-colors px-1"
                                        >
                                            {children}
                                        </a>
                                    ),
                                    img: ({ src, alt }) => (
                                        <img
                                            src={src}
                                            alt={alt}
                                            className="my-8 w-full border-4 border-black dark:border-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,0.3)]"
                                        />
                                    ),
                                    hr: () => (
                                        <hr className="my-12 border-0 h-1 bg-black dark:bg-white" />
                                    ),
                                    table: ({ children }) => (
                                        <div className="overflow-x-auto my-8">
                                            <table className="w-full border-4 border-black dark:border-white shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.3)] bg-white dark:bg-[#2d2d44]">
                                                {children}
                                            </table>
                                        </div>
                                    ),
                                    thead: ({ children }) => (
                                        <thead className="bg-[#FFE156]">
                                            {children}
                                        </thead>
                                    ),
                                    th: ({ children }) => (
                                        <th className="border-2 border-black dark:border-white px-4 py-3 text-black font-black uppercase text-left text-sm tracking-wide">
                                            {children}
                                        </th>
                                    ),
                                    td: ({ children }) => (
                                        <td className="border-2 border-black dark:border-white px-4 py-3 text-black dark:text-white font-mono text-sm">
                                            {children}
                                        </td>
                                    ),
                                    strong: ({ children }) => (
                                        <strong className="font-black text-black dark:text-white bg-[#A0E7E5] px-1">
                                            {children}
                                        </strong>
                                    ),
                                    em: ({ children }) => (
                                        <em className="italic text-black dark:text-white bg-[#DDA0DD]/50 px-1">
                                            {children}
                                        </em>
                                    ),
                                }}
                        ...
                        <div className="text-center py-20">
                            ...
                            <h3 className="text-2xl font-black uppercase mb-3">Content Not Available</h3>
                ...
                {!isFullscreen && (
                    <div className={`mt-12 pt-8 flex justify-between items-center animate-fadeIn ${isPageType ? 'border-t-4 border-black dark:border-white' : 'border-t border-border'}`}>
                        <button 
                            onClick={() => navigate("/cheatsheets")}
